        ...
        <div className="flex justify-between h-full">
          <div className="text-gray-700 text-center flex items-center align-items cursor-pointer">
            <h1 className="flex justify-center w-full">
              <Link to={ROUTES.DASHBOARD} aria-label="Gladygram logo">
                <img src="/images/logo.png" alt="Gladygram" className="mt-2 w-6/12"/>
              </Link>

            </h1>
          </div>
          <div className="text-gray-700 tet-center flex items-center align-itmes">
            {user.username ? (
              <>
                <Link to={ROUTES.DASHBOARD} aria-label="Dashboard">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-8 lg:mr-6  text-black-light cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <>
                ...
                <Link to={ROUTES.SIGN_UP}>
                  <button type="button" className="font-bold rounded text-blue-medium w-20 h-8">Sign Up</button>
                </Link>
              </>
            )}
          </div>
